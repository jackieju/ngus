...
public class UpdateTodo extends javax.servlet.http.HttpServlet implements
javax.servlet.Servlet {
	public void doPost(HttpServletRequest request,
		...
		resId = ParamUtils.getParameter(request, "resourceId");
		resId.trim();


		try{
			String xml="<?xml version=\"1.0\" encoding=\"utf-8\"?>"+
				"<ro resId=\""+resId +"\" shareLevel=\"0\" title=\"todo\" tags=\"1,2,3\" type=\"1\" storageType=\"1\" storagePath=\"/tree/todo\" resourceType=\"doc\">"+ 
				content + 
				"<list name=\"rdo\">"+					
			...
			ro= ResourceObject.fromXML(xml);
			ro.setUser(uid);
			ro.setResId(resId);
			
			DataEngine.instance().post(ro);
			resId= ro.getResId();
		} catch (Exception e) {
			Log.error(e);
			out.print('0');
