 ...
 * 
 */
public class WebOSSearch extends javax.servlet.http.HttpServlet implements
	...
	protected void doPost(HttpServletRequest request,
		...
		SearchKeyService.getInstance().addKey(key);
		int total_pages = 1;
		...
		if(!type.equalsIgnoreCase("user")){
			rd = request.getRequestDispatcher("webos_search.jsp");
		}
		else{
			rd = request.getRequestDispatcher("webos_searchUser.jsp");
		}		
