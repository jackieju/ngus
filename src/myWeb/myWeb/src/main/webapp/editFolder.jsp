...
<div class="leftbox">
<br />
<bean:parameter id="arg1" name="id" value="" />
<table width="100%" border="0" cellpadding="5" cellspacing="0"
	align="center">
	<tr>
		<td width="100%" valign="top" style="BORDER: #e6e8df 5px solid"
			bgcolor="#ffffff" align="left"><html:form action="/editFolder.do">
			<code>编辑目录</code>
			<br />
			<html:errors />
			<input type="hidden" name="id" id="id"
				value="<bean:write name="arg1" />" />
			<code>标题:</code>
			<br />
			<html:text property="name" size="16" maxlength="16" value="<%=name%>"/>
			<br />
			<code>描述:</code><br />
			<html:textarea property="description" rows="5" cols="40" value="<%=description%>"/>
			<br />
...
<table border="0" cellspacing="0" width="100%">
	...
	<tr>
		<td colspan="2">copyright&copy; all rights reserved</td>
	</tr>
</table>
</div>
</div>
