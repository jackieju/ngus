	...
	<head>
		...
		<script type="text/javascript">
			...
			function changePage(){
				...
				window.location.href="webos_bookmark.jsp?id="+id+"&page="+page;
			}
						...
						<form class="search_form" method="post" action="search">
						 ...
						 <div class="content_main">
								<div class="inner_content_main">
									<div class="bookmark_detail">
										...
										<div class="bookmark-operate">
											<div id="digg" onclick="vote('<%=URLEncoder.encode(res.getURL() ,"UTF-8") %>')"><a id="vote_number" href="#"><%=vote%></a></div>
							...
							<div class="page_list">
								...
								%>
								<a href="webos_bookmark.jsp?id=<%=idUrl%>&page=<%=currPage-1%>"><img src="images/pre_arrow.gif" align="absmiddle" /></a>
								<%
									}
								%>
								&nbsp;<%=currPage %>/<%=totalpage %>&nbsp;
								...
								%>
								<a href="webos_bookmark.jsp?id=<%=idUrl%>&page=<%=currPage+1%>"><img src="images/next_arrow.gif" align="absmiddle" /></a>
								<%
									}
								%>
							...
							<div class="input_review">
								<form name="addComment" method="get" action="webos_bookmark.jsp">
