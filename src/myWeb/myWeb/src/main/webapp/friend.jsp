					...
					<div class="panel_content">
						<div class="inner-content">
							...
							<div class="page">
								...
								<% 
									...
									if(current_page==1){
										...
										out.print("<a href=\"friend.jsp?&page="+(current_page-1)+"\">上一页</a>");
									}
								%>
								</div>
								<%
									...
									for(int i=1; i<6&&i<=total_pages; i++){
										...
										if(i%5==current_page%5){
											...
											out.print("<a href=\"friend.jsp&page="+i+"\">"+i+"</a>");
										}
										out.print("</div>");
									}									
								%>							
								...
								<%
									if(current_page==total_pages){
										...
										out.print("<a href=\"friend.jsp&page="+(current_page+1)+"\">下一页</a>");
									}
								%>								
								</div>
							</div>
							...
							<div class="content-panel">
								<div class="content-panel-title">“ <span class="red"></span> ”搜索结果 （共找到<span class="red"><bean:write name="count"/></span>个结果）</div>
									...
									<ul>
										...
										<li>
											...
											<div class="search-result">		
												<span style="float:left"><img src="userPic?userName=<bean:write name="user" property="userName"/>" height = 50/></span>
												<span>
												...
												<a href="deleteFriend.do?userId=<%=UserManager.getCurrentUser().getUserId() %>&friendId=<bean:write name="user" property="userId" />">删除</a>										
												</span>
											</div>
										</li>
										</logic:iterate>							
