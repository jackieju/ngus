					...
					<!--content start####################################################-->
							...
							<div class="content-panel">
								...
								<div class="content-panel-content">
									...
									<div id="bk_display" style="float: left; border: 1px solid gray; width: 720px; height: 350px; overflow:auto">
										
										
										<logic:notPresent name="email">
										<div align="center" valign="middle">
										<html:form action="/changeInfo" method="POST" enctype="multipart/form-data">
											邮箱地址:<html:text property="email"/><br/>
											手机号码:<html:text property="mobile"/><br/>
											头像：<html:file property="userPic" /><br/>
										...
										<logic:present name="email">
											<div align="center">你的修改信息为Email:<bean:write name="email"/>，手机为<bean:write name="mobile"/></div>
										</logic:present>
