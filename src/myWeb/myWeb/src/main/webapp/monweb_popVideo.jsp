	...
	<body>
		...
		<div id="mainwrap">
			...
			<div id="header">
				...
				<%if(userName!=null){ %>
				<div class="head-register"><a href="main.jsp">我的资源</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="monweb_QA.jsp">帮助</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="monweb_reg.jsp">注册</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="monweb_login.jsp">登录 </a></div>	
				<%}else{ %>
				<div class="head-register"><a href="main.jsp">首页</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="monweb_QA.jsp">帮助</a></div>	
				<%} %>
				...
				<div id="main">
					...
					<div>
						<ul class="nav">
							...
							<li class="initial_tab_on"><a href="ListPopByType?type=video"><img src="images/icon_video.gif" />&nbsp;视频</a></li>
						...
						<div class="page_list">
							<%								
								if(current_page<=5){
									...
									out.println("<a href=\"ListPopByType?type=video&currPage="+(current_page/5*5+1)+"\"><img src=\"images/pre_arrow.gif\" align=\"absmiddle\" /></a>");
								}
							%>							
							<%	
								for(int i=(current_page-1)/5*5+1; i<=5; i++){
									if(i>0&&i<=total_pages){
										if(i!=current_page){
											out.println("<a href=\"ListPopByType?type=video&currPage="+(i)+"\">"+i+"</a>");
										}
										else{
											out.println(i);
										}
							...
							<%
								if((current_page-1)/5==(total_pages-1)/5){
									...
									out.println("<a href=\"ListPopByType?type=video&currPage="+(current_page/5*5+6)+"\"><img src=\"images/next_arrow.gif\" align=\"absmiddle\" /></a>");	
								}
							%>							
							&nbsp;到<form action="ListPopByType" style="display:inline" ><input type="hidden" name="type" value="video" /><input type="text" name="page" class="text" style="width:15px"/>页&nbsp;<input type="submit" value="GO" class="page_hop" /></form>
						</div>
